...
public class MainActivity extends ActionBarActivity implements QuotesFragment.Callback {
...
//        mLocation = Utility.getPreferredLocation(this);
        ...
        QuotesFragment quotesFragment =  ((QuotesFragment)getSupportFragmentManager()
                .findFragmentById(R.id.fragment_forecast));
        quotesFragment.setUseTodayLayout(!mTwoPane);
